...
export declare type TElementAttribute = [
    1 | undefined,
    string,
    string
];
export declare type TElementAttributeList = Array<TElementAttribute>;
export declare type TElementAttributes = [
    1 | string | undefined,
    TElementAttributeList | undefined
];
export declare type TElement = [
    NodeType.ELEMENT,
    Array<string | undefined> | undefined,
    1 | undefined,
    1 | undefined,
    string | undefined,
    TElementAttributes | undefined,
    TContent | undefined
];
