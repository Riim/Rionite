...
test('content super (2)', () => {
	...
	expect(
		t1
			...
			.render()
	).toBe('<b class="block1-x__el1 block1__el1"></b><i class="block1-x__el2 block1__el2"></i>');
});
...
test('helper super', () => {
	...
	expect(
		...
		'<b class="block1-x__$test block1__$test block1-x__test block1__test" attr1="value1" attr2="value2"></b>'
	);
});
